  ...
  <div class="p-4">
    ...
    <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
      ...
      <div class="wrapper-button w-full box-border mt-4">
        <router-link to="/component/newEvaluation" exact>
          <button type="button"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Nova
            APO
          </button>
      ...
      <div class="wrapping-table mt-10">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 lg:overflow-auto overflow-x-scroll">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th scope="col" class="uppercase px-6 py-3">Nome Avaliação</th>
              <th scope="col" class="uppercase px-6 py-3">Data</th>
              <!-- <th scope="col" class="uppercase px-6 py-3">Amount</th>-->
              <th scope="col" class="uppercase px-6 py-3">Status</th>
              <th scope="col" class="uppercase px-6 py-3">Ações</th>
            </tr>
          </thead>
          <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50"
              v-for="items in tableData" :key="items.evaluationName">
              <td class="px-6 py-4">
                {{ items.evaluationName }}
              </td>
              <td class="px-6 py-4">
                {{ items.datetime }}
              </td>
              <td class="px-6 py-4">
                <span class="text-green-800 bg-green-300 px-3 py-1 rounded-md"
                  v-if="items.statusEvaluation == 'Completa'">
                  {{ items.statusEvaluation }}
                </span>
                <span class="text-purple-800 bg-purple-300 px-3 py-1 rounded-md"
                  v-else-if="items.statusEvaluation == 'Em progresso'">
                  {{ items.statusEvaluation }}
                </span>
              ...
              <td class="px-6 py-4">
                <div class="wrapper-button w-full box-border mt-4 flex md:space-x-2">
      ...
      <div class="wrapper-button mt-3">
        ...
        >
          <option value="">10 Ultimas avaliações</option>
        </select> -->
        <!-- <button
...
export default {
  ...
  data() {
    return {
      tableData: [
        {
          evaluationName: "Avaliação 1",
          datetime: "Apr 22, 2022",
          statusEvaluation: "Completa",
        },
        {
          evaluationName: "Avaliação 2",
          datetime: "May 2, 2022",
          statusEvaluation: "Completa",
        },
        {
          evaluationName: "Avaliação 3",
          datetime: "May 5, 2022",
          statusEvaluation: "Em progresso",
        },
        {
          evaluationName: "Avaliação 4",
          datetime: "May 5, 2022",
          statusEvaluation: "Cancelada",
        },
      ],
    }
  }
